...
1. Filename
2. Free model maximized likelihood
3-5. Di, tri and tetraploid fixed model maximized likelihoods
6-8. Delta log-likelihoods for di, tri and tetraploid models
